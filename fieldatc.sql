...
-- Database: `clg`
--
CREATE DATABASE IF NOT EXISTS `clg` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `clg`;
...
INSERT INTO `application` (`id`, `firstname`, `middlename`, `surname`, `phone`, `email`, `programme`, `education`, `mathematics`, `physics`, `chemistry`, `biology`, `english`, `certificate`, `age`) VALUES
